...
##  created by Mikis Stasinopoulos  and Bob Rigby, Friday, November 8, 2002.
##  last change Tuesday, September 21, 2004 at 15:13
wp<- function (object, 
               xvar = NULL, 
               n.inter = 4,
               xcut.points = NULL, 
...
##-----------------------------------------------------------------------------
 panel.fun<-function (x, y, col = par("col"), bg = NA, pch = par("pch"), 
   ...
   if(line == TRUE)
      ...
      assign("coef1",coef(fit),env = parent.frame(n=3))
      assign( "coef" , c(coef, coef1),env = parent.frame(n=3))
      }
  }                
##-----------------------------------------------------------------------------
...
##-here is the main function ------------------------------------------------------------
   ...
   {
           w <- object$weights # geting the weights
